...
from utils.GPU_params_manager import ParamsManager
...
args.add_argument("--params-file", help = "Path del fichero JSON de parámetros. El valor por defecto es parameters.json",
                  default="GPU_parameters.json", metavar = "PFILE")
    ...
    while global_step_num < agent_params['max_training_steps']:
        ...
        while not done:  # mientras no haya terminado
            ...
            if done is True:
                ...
                if num_improved_episodes_before_checkpoint >= agent_params['save_freq']:# si a mejorado mas de 50 veces
